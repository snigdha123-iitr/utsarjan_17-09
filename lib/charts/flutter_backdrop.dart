...
// import 'package:edexpro/charts/model.dart';
...
class Backdrop extends StatefulWidget {
  ...
  @override
  BackdropState createState() => BackdropState(controller);
}

class BackdropState extends State<Backdrop>
    with SingleTickerProviderStateMixin {
  BackdropState(AnimationController _controller, {this.test = false}) {
